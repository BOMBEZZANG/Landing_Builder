...
const translations = {
  ...
  ko: {
    title: '랜딩 페이지 빌더',
    subtitle: '몇 분 만에 아름답고 전문적인 랜딩 페이지를 만드세요. 간단하고 빠르게 제작됩니다',
    features: {
      fast: {
        title: '초고속',
        description: '직관적인 드래그 앤 드롭 인터페이스로 10분 안에 랜딩 페이지를 만드세요.'
      },
      noCode: {
        title: '코딩 불필요',
        description: '인라인 편집이 가능한 비주얼 에디터. 전문적인 페이지를 만드는 데 기술적 지식이 필요 없습니다.'
      },
      mobile: {
        title: '모바일 최적화',
